...
<head>
  ...
  <title>Smurfts | Registration Page</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('templates/backend/AdminLTE-3.0.1') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="register-box">
  ...
  <div class="card">
    ...
    <div class="mb-4">
      <input type="hidden" class="form-control" name="role" placeholder="siswa" value="siswa">
  </select>
        <div class="row">
          <!-- /.col -->
          <div class="col-4">

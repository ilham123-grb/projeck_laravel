...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="/" class="brand-link">
    <img src="{{ asset('img/icons') }}/bg2.jpg" alt="smurfts Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Smurfts</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ asset('img/icons') }}/bg5.jpg" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @endif
        <li class="nav-item">
            <a href="{{ route('admin.transaksi.datapaket') }}" class="nav-link {{ Request::segment(2) == 'transaksi' ? 'active' : '' }}">
              <i class="nav-icon fas fa-users"></i>
              <p>
                Siswa
              </p>

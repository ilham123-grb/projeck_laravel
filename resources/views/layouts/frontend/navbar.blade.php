<div class="clever-main-menu">
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="/"><img src="{{ asset('img/icons') }}/bg2.jpg" width="50" alt=""> SMURFTS</a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        ...
                        <li><a href="{{ route('paket') }}" class="{{ Request::is('paket') ? 'text-primary' : '' }}">paket</a></li>
                        <li><a href="{{ route('register') }}" class="{{ Request::is('register') ? 'text-primary' : '' }}">register</a></li>
